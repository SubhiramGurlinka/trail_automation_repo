...
def get_bessite_modification(bes_site_html):
    ...
    newest_mod = datetime.datetime.strptime("Thu, 1 Jan 1970 00:00:01 +0000\r", '%a, %d %b %Y %H:%M:%S %z\r')

    for result in site_mod:
        result_parsed = datetime.datetime.strptime(result.decode(), '%a, %d %b %Y %H:%M:%S %z\r')
...
if __name__ == "__main__":
    try:
        ...
        bes_site = "https://sync.bigfix.com/cgi-bin/bfgather/updateslinuxappsmiddleware"
        exit(main(bes_site))
